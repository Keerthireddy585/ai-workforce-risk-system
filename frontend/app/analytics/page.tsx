...
export default function AnalyticsPage() {
    ...
    const [selectedEmployee, setSelectedEmployee] = useState(2)
      ...
      axios
       ...
       axios
        ...
        //    `${process.env.NEXT_PUBLIC_API_URL}/employee-history/2`
           `${process.env.NEXT_PUBLIC_API_URL}/employee-history/${selectedEmployee}`
       )
...
{/* 
            ...
            {/* burnout risk distribution */}
                ...
                <p className="text-gray-600 mb-4">
                  Showing productivity history for{" "}
                ...
                <div className="bg-white p-6 rounded-2xl shadow-md mb-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 text-black border-l-4 border-blue-500 p-4 rounded">
                      {productivityStatus}
                    </div>

                    <div className="bg-yellow-50 text-black border-l-4 border-yellow-500 p-4 rounded">
                      {highestDepartment} currently has the highest workforce allocation.
                    </div>

                    <div className="bg-red-50 text-black border-l-4 border-red-500 p-4 rounded">
                      {burnoutStatus}
                    </div>

                    <div className="bg-green-50 text-black border-l-4 border-green-500 p-4 rounded">
                      {projectStatus}
                    </div>
